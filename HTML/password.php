...
<body>
    ...
    if (isset($NewUser)) {
        ...
        if (!($file = fopen("password.txt", "r"))) {
            print ("<title>Error</title></head><body>Could not open the password file </body></html>");
            die();
        }
        $userVerified = 0;
    ...
    {
        print ("<title>Thank you</title></head><body style= \"font-family: Arial; font-size: 1em; color: green\">
        <strong>You have been added to the user list, $name. <br /> Please go back and login with your password </strong>");
        sleep(2);
        echo '<script type="text/javascript">
        window.open("https://fishtecho.com/html/password.html", "_self");
        </script>';
    ...
    function accessGranted($name)
    {
        ...
        sleep(3);
        echo '<script type="text/javascript">
        window.open("https://fishtecho.com/?page_id=81", "_self");
        </script>';
    }
